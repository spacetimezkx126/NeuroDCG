...
parser.add_argument('--news_path', type=str, default='./dataset/cmin_us_extracted', help='Path to news data')
parser.add_argument('--price_path', type=str, default='./CMIN-US/price/preprocessed', help='Path to price data')
...
class ProcessedDataset(Dataset):
    def __init__(self, data_path, split='train', transform=None, ds_name = 'CMIN-US', news_path = './dataset/cmin_us_extracted', price_path = './dataset/CMIN-US/price/preprocessed', mode = 'all', data_num = 'all'):
    ...
    def load_sample_meta(self):
        ...
        hetero_data['news_token'].x = torch.zeros((1,5,40)).long()
